...
insert into product (name, price, category, detail) values ('和財布(女性用)', 4100, '財布・小物入れ','日本らしい奥ゆかしさを持つ財布です。見た目はもちろんのこと、機能面でも充実しており、8つのカードポケットがついています。');
insert into product (name, price, category, detail) values ('市松文様 小物入れ', 2500, '財布・小物入れ','市松文様をスタイリッシュに使用した小物入れです。');
insert into product (name, price, category, detail) values ('籠', 1900, '財布・小物入れ','使い方次第で、様々な用途に利用できます。');
insert into product (name, price, category, detail) values ('ランチョンマット', 900, '食卓用','お椀やお箸によく似合う、和風のランチョンマットです。');
insert into product (name, price, category, detail) values ('お椀', 900, '食卓用','レンジにも対応している、和風モダンなお椀です。');
insert into product (name, price, category, detail) values ('夫婦箸', 1800, '食卓用','名入れも可能です。夫婦やカップルでどうぞ。');
insert into product (name, price, category, detail) values ('扇子', 820, 'その他','エコな時代に最適。ファッショナブルな扇子です。');
insert into product (name, price, category, detail) values ('手染め 手ぬぐい', 520, 'その他','手染めの手ぬぐいです。');
